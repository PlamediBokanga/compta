...
export function DeclarationsPage() {
  ...
  const [typeFilter, setTypeFilter] = useState<'all' | DeclarationType>('all');
  const [statusFilter, setStatusFilter] = useState<'all' | DeclarationStatus>('all');
  ...
  const visibleDeclarations = useMemo(() => declarations.filter((item) => (typeFilter === 'all' || item.type === typeFilter) && (statusFilter === 'all' || item.status === statusFilter)), [declarations, typeFilter, statusFilter]);
